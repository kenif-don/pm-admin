...
<div>
  <jf-querys>
    <jf-query-item label="名称：">
       <el-input v-model="page.clzObj.name" placeholder="请输入名称" clearable/>
    </jf-query-item>
    <jf-query-item label="标识：">
       <el-input v-model="page.clzObj.value" placeholder="请输入标识" clearable/>
    </jf-query-item>
    <jf-query-item>
  ...
  <el-dialog title="字典分类" v-model="dialogVisible" width="85%">
...
<script>
import * as api from '@/api/dic/dic-type';
