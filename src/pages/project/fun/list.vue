...
<div>
  <div class="query-box">
    <div class="query-items">
          ...
          <div class="query-item">
            <div class="query-label">所属项目模块：</div>
               <el-select v-model="page.clzObj.projectModelId" filterable placeholder="请选择所属项目模块">
                <el-option
          ...
          <div class="query-item">
            <div class="query-label">具体功能实现：</div>
              <el-input v-model="page.clzObj.fun" placeholder="请输入具体功能实现" clearable/>
          </div>
          <div class="query-item">
    ...
    <div class="query-btns">
      ...
      <el-button type="primary" @click="open">添加项目模块功能</el-button>
    </div>
  </div>
  <div class="main">
    <el-table :data="data" border style="width: 100%">
      <el-table-column prop="id" label="编号" width="50"/>
          ...
          <el-table-column label="所属项目模块">
            <template slot-scope="scope">{{scope.row.projectModel.name}}</template>
          </el-table-column>
          <el-table-column prop="fun" label="具体功能实现"/>
  ...
  <el-dialog :close-on-click-modal="false" title="项目模块功能" :visible.sync="dialogVisible" width="60%">
    ...
    <div class="form-item-inline-box">
      <el-form-item label="所属项目模块:">
           <el-select v-model="form.projectModelId" filterable placeholder="请选择所属项目模块">
            <el-option
              v-for="item in projectModelList"
              :key="item.id"
              :label="item.name"
      ...
      <el-form-item label="具体功能实现:">
          <el-input v-model="form.fun" placeholder="请输入具体功能实现" clearable/>
      </el-form-item>
    </div>
    <div class="form-item-inline-box">
...
<script>
import * as api from '@/api/fun'
import {selectList as selectProjectModelList} from '@/api/project_model_id'
export default {
  components: {},
  data() {
    return {
  ...
  mounted() {
    this.paging();
    selectProjectModelList({}).then(data=>{
